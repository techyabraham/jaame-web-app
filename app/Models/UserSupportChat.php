...
class UserSupportChat extends Model
{
    ...
    protected $appends = ['senderImage','chatFile'];
    ...
    public function getChatFileAttribute() {
        return get_image(@json_decode($this->file_path)->file_name,'support-attachment');
        // return json_decode($this->file_path);
    }
}
