...
class RejectedByAdminMail extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
                        ...
                        ->subject("Add Money Via". @$data->gateway_currency->name."Payment Rejected by admin")
                        ->line("Your add money request via ".@$data->gateway_currency->name." rejected by admin, details of add money:")
                        ...
                        ->line("Rejected Reason: " .@$data->reject_reason)
