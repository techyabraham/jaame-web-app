...
class EscrowRequest extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
                    ...
                    ->subject("Escrow request from ". $basic_settings->site_name)
                    ->line('A user created an escrow with you. Please go to your escrow page and check it now.')
