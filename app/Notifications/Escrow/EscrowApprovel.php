...
class EscrowApprovel extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
                    ...
                    ->subject("Escrow Approvel Payment from ". $basic_settings->site_name)
                    ->line('A user has paid your escrow. Please go to your escrow page and check it now.')
