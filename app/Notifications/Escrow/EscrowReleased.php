...
class EscrowReleased extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
                    ...
                    ->subject("Escrow payment released from ". $basic_settings->site_name)
                    ->line('A buyer released your payment. Please go to your escrow page and check it now.')
