...
namespace App\Notifications\Escrow;
...
class EscrowReleasedRequest extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
                    ...
                    ->subject("Escrow release request from ". $basic_settings->site_name)
                    ->line('A seller is requested to release there payment. Please go to your escrow page and check it now.')
