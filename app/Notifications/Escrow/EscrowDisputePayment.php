...
class EscrowDisputePayment extends Notification
{
    use Queueable;
   ...
   /**
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
                    ...
                    ->subject("Escrow dispute payment from ". $basic_settings->site_name)
                    ->line('A user dispute the payment. Please go to your escrow page and check it now.')
