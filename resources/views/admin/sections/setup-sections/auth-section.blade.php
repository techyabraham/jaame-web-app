                                ...
                                <div class="tab-pane @if (get_default_language_code() == language_const()::NOT_REMOVABLE) fade show active @endif" id="english" role="tabpanel" aria-labelledby="english-tab">
                                    <div class="form-group">
                                        @include('admin.components.form.input',[
                                            'label'     => __("Login Section Title*"),
                                            'name'      => $default_lang_code . "_login_title",
                                            'value'     => old($default_lang_code . "_login_title",$data->value->language->$default_lang_code->login_title ?? "")
                                        ])
                                    </div>
                                    <div class="form-group">
                                        @include('admin.components.form.input',[
                                    ...
                                    <div class="form-group">
                                        @include('admin.components.form.input',[
                                            'label'     => __("Register Section Title*"),
                                            'name'      => $default_lang_code . "_register_title",
                                            'value'     => old($default_lang_code . "_register_title",$data->value->language->$default_lang_code->register_title ?? "")
                                        ])
                                    </div>
                                    <div class="form-group">
                                        @include('admin.components.form.input',[
                                    ...
                                    <div class="form-group">
                                        @include('admin.components.form.input',[
                                            'label'     => __("Forget Section Title*"),
                                            'name'      => $default_lang_code . "_forget_title",
                                            'value'     => old($default_lang_code . "_forget_title",$data->value->language->$default_lang_code->forget_title ?? "")
                                        ])
                                    </div>
                                    <div class="form-group">
                                        @include('admin.components.form.input',[
                                ...
                                @foreach ($languages as $item)
                                    ...
                                    <div class="tab-pane @if (get_default_language_code() == $item->code) fade show active @endif" id="{{ $item->name }}" role="tabpanel" aria-labelledby="english-tab">
                                        <div class="form-group">
                                            @include('admin.components.form.input',[
                                                'label'     => __("Login Section Title*"),
                                                'name'      => $lang_code . "_login_title",
                                                'value'     => old($lang_code . "_login_title",$data->value->language->$lang_code->login_title ?? "")
                                            ])
                                        </div>
                                        <div class="form-group">
                                            @include('admin.components.form.input',[
                                        ...
                                        <div class="form-group">
                                            @include('admin.components.form.input',[
                                                'label'     => __("Register Section Title*"),
                                                'name'      => $lang_code . "_register_title",
                                                'value'     => old($lang_code . "_register_title",$data->value->language->$lang_code->register_title ?? "")
                                            ])
                                        </div>
                                        <div class="form-group">
                                            @include('admin.components.form.input',[
                                        ...
                                        <div class="form-group">
                                            @include('admin.components.form.input',[
                                                'label'     => __("Forget Section Title*"),
                                                'name'      => $lang_code . "_forget_title",
                                                'value'     => old($lang_code . "_forget_title",$data->value->language->$lang_code->forget_title ?? "")
                                            ])
                                        </div>
                                        <div class="form-group">
                                            @include('admin.components.form.input',[
